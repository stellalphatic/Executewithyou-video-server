...
impl ParticipantState {
    pub fn new(id: String, display_name: String, role: ParticipantRole) -> Self {
        // Guests start NOT on stage (backstage) - they need to be brought on stage by host
        // Only hosts/co-hosts start on stage
        let is_on_stage = match role {
            ParticipantRole::Host | ParticipantRole::CoHost => true,
            ParticipantRole::Guest | ParticipantRole::Viewer => false,
        };
